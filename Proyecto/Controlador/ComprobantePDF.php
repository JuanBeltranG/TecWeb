            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        <h4 class="text-white">Salir al menú</h4>
                        <p class="text-muted">¿Estás seguro de querer salir al menú?</p>
                    </div>
                    <div class="col-sm-4 offset-md-1 py-4">
                        <div class="d-grid gap-2">
                            <button type="button" class="btn btn-danger" onclick="location.href='../Vista/Paginas/index.html'">Salir al menú</button>
                        </div>
                    </div>
                </div>
            </div>
